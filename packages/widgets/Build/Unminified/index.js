...
function FullscreenButtonViewModel(fullscreenElement, container) {
  ...
  this._fullscreenElement = getElement7(fullscreenElement) ?? ownerDocument.body;
  ...
  fullscreenElement: {
    ...
    set: function(value) {
      if (!(value instanceof Element)) {
        throw new DeveloperError13("value must be a valid Element.");
      }
...
function PerformanceWatchdogViewModel(options) {
  if (!defined23(options) || !defined23(options.scene)) {
    throw new DeveloperError17("options.scene is required.");
  }
  this._scene = options.scene;
...
function PerformanceWatchdog(options) {
  if (!defined24(options) || !defined24(options.container)) {
    throw new DeveloperError18("options.container is required.");
  }
  if (!defined24(options.scene)) {
...
import {
  ...
  Cesium3DTileset as Cesium3DTileset2,
  Clock as Clock2,
...
function findFirstTileset(primitives) {
  ...
  for (let i = 0; i < length; ++i) {
    ...
    if (primitive instanceof Cesium3DTileset2) {
      return primitive;
    }
  }
  return void 0;
